...
public class ShootNoAlignSwerve extends Command {
  ...
  public ShootNoAlignSwerve(Arm arm, Shooter shooter, Intake intake, Feeder feeder, Limelight limelight, double speed) {
    mArm = arm;
    //mShooter = shooter;
    mShooter = shooter;
    mIntake = intake;
